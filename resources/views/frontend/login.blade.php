    ...
    <div class="main-singin-box">
        <div class="leftside">
            <div class="air-balloon one">
                <img src="images/404-balloon.png" alt="404-balloon">
            </div>
        ...
        <div class="container">
            <div class="singin-box">
                <div class="singin-left">
                    ...
                    <ul class="login-btns">
                        <li>
                            <a href="javascript:;" class="btn-fb">Login with Facebook</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="btn-g">Login with Google</a>
                        </li>
                    </ul>
                ...
                <div class="singin-right">
                    <div class="main-form">
                        <h4>Welcome to Long Life </h4>
                        <form method="POST" action="{{ route('login') }}">
                            @csrf
                            <div class="form-input">
                                <input type="email" name="email" id="validationCustom02" placeholder="Email Address *" required>
                                <label for="validationCustom02"><i class="fas fa-envelope"></i></label>
                            </div>
                            <div class="form-input">
                                <input type="password" name="password" id="validationCustom04" placeholder="Password *" required>
...
<!-- Mirrored from webstrot.com/html/fervor/html/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 08:30:00 GMT -->
</html>