...
<head>
    <meta charset="utf-8">
    <title>Link-Up Login</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta name="description" content="link-up" />
    <meta name="keywords" content="link-up" />
        ...
        <div class="container">
            <div class="singin-box">
                ...
                <div class="singin-right">
                    <div class="main-form">
                        <h4>Sign Up To long life</h4>
                        <form>
                            <div class="form-input">
                                <input type="text" name="username" id="validationCustom01" placeholder="User name *"
                                    required="">
